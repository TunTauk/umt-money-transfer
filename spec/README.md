...
Internal system for a Myanmar money-transfer shop: customers send cash to be
wired to a recipient elsewhere ("Send"), or receive cash here against a
transfer that landed in one of our accounts ("Payout"). The system tracks
every kyat across our bank/wallet accounts and cash drawer, and collects a
...
6. [OCR & Payout Verification](06-ocr-payout-verification.md) — upload/OCR flow
