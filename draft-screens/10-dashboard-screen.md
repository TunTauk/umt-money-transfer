...
warning signals — an account running low risks blocking the next Cash In
...
- Rows show name, transaction type (`CASH_IN`, `CASH_OUT`, `CAPITAL_DEPOSIT`,
...
data. Instead, [Cash In](11-cash-in-screen.md#filter-bar),
